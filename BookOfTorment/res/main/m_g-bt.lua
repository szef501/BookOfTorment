...
Infinity_RegisterFile("en_g-bt.lua")
if(uiTranslationFile) then
	Infinity_RegisterFile(string.sub(uiTranslationFile,1,3).."g-bt.lua")
end


--    Label Key, 				Description Key, 				 #Values, Base value, multiplier, slider value,   INI section name, 	INI option key
SkinsOptionsSliders = {
	{"_LABEL",		"_DESCRIPTION",			3,		0,		1,			0,			"Graphics",		"Dialogue Box Skin"},
